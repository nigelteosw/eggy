...
// internal/google and internal/mcp -- those answer "what may Eggy do on the owner's behalf".
...
// Eggy-specific type. It lives beside internal/auth/authfile rather than in the
