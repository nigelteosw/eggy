...
// modality. known is false whenever the
...
func (d *modelDiscovery) SupportsPart(ctx context.Context, alias string, kind ports.Modality) (supported, known bool) {
