...
// single fixed thread, or one web thread -- a turn's replies, approval
// decisions, and events should reach. Approvals, events, and the turn
// orchestrator are all consumers of Destination; none of them owns it.
package destination
