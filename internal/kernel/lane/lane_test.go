...
func TestDetect(t *testing.T) {
	tests := []struct {
		...
		{name: "negated implement", text: "Do not implement anything", want: Assistant},
		{name: "contracted negated implement", text: "Don't implement this", want: Assistant},
		{name: "without implementing", text: "Explain it without implementing changes", want: Assistant},
		{name: "review implementation", text: "Review this implementation", want: Assistant},
		{name: "explain implementation", text: "Explain the implementation", want: Assistant},
		...
		{name: "remove repository allowlist", text: "Remove eggy from the repository allowlist", want: Assistant},
		{name: "add search to eggy", text: "add web search to eggy", want: Implementation},
		{name: "add search capability", text: "can you add a web search capability", want: Implementation},
		{name: "build search tool", text: "build a web search tool for eggy", want: Implementation},
		{name: "build my schedule", text: "build my schedule for the week", want: Assistant},
		{name: "give ability unsupported verb", text: "give eggy the ability to search the web", want: Assistant},
