  ...
  return (
    <label className={cn("group inline-flex min-h-11 cursor-pointer items-center gap-3 text-sm text-foreground", className)}>
      <span className="relative inline-flex h-[22px] w-[38px] shrink-0 items-center">
        ...
        <span
          className={cn(
            "h-[22px] w-[38px] rounded-full bg-neutral-300 transition-colors",
        ...
        <span
          className={cn(
            "pointer-events-none absolute left-[2px] h-[18px] w-[18px] rounded-full bg-neutral-100 shadow-subtle transition-transform",
